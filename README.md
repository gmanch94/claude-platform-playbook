...
| An individual being onboarded — how your *own* work changes | [`user-mindset-cheatsheet.md`](artifacts/user-mindset-cheatsheet.md) → [`claude-misconceptions.md`](artifacts/claude-misconceptions.md) |
