...
| Admin API — org management (members / workspaces / keys) | GA | 2026-07 | platform.claude.com/docs/en/manage-claude/admin-api | usage-compliance-monitoring, enterprise-deployment-guide |
