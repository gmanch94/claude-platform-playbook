...
| Admin API — org management (members / workspaces / keys) | GA | 2026-07 | platform.claude.com/docs/en/manage-claude/admin-api | usage-compliance-monitoring, enterprise-deployment-guide, enterprise-workspaces-guide |
...
| Workspace lifecycle & roles (Console + Admin API; archive-only no delete; 100/org cap, archived don't count) | GA | 2026-07 | platform.claude.com/docs/en/manage-claude/workspaces | enterprise-deployment-guide, enterprise-workspaces-guide |
...
| Workload Identity Federation (service accounts `svac_` + federation rules; keyless CI via RFC 7523 jwt-bearer → short-lived `sk-ant-oat01-`) | GA | 2026-07 | platform.claude.com/docs/en/manage-claude/workload-identity-federation | enterprise-workspaces-guide, claude-code-enterprise-config |
