...
| Audit logs (Enterprise) | GA | 2026-07 | support.claude.com/en/articles/9970975-access-audit-logs | usage-compliance-monitoring, governance-overlay |
| Compliance API (Enterprise + Platform; excl. Public Sector) | GA | 2026-07 | platform.claude.com/docs/en/manage-claude/compliance-api | usage-compliance-monitoring, governance-overlay, procurement-pack |
