...
> 7 read-only MCP server patterns for Claude Code + Agent SDK rollouts. Each framed by **when-to-use / failure-mode / owner / config body** before the config itself. Pinned to current Claude surface (Opus 5 / Sonnet 5 / Haiku 4.5, MCP GA as of 2026-07).
