...
**As of 2026-06.** Pin to current model surface (Opus 4.8 / Sonnet 5 / Haiku 4.5). Companion to [`claude-code-adoption-guide.md`](claude-code-adoption-guide.md). See [`../docs/feature-inventory.md`](../docs/feature-inventory.md) for the canonical Skills + plugin surface inventory.
