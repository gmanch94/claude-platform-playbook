...
**As of 2026-07.** Pin to current model surface (Opus 5 / Sonnet 5 / Haiku 4.5) — refresh monthly.
...
- Model tier routing (Haiku 4.5 triage → Sonnet 5 default → Opus 5 escalation only when justified)
