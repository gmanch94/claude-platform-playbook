...
| **Claude Design** | Product, UX, design | **Team / Enterprise** (Labs toggle) | Inside chat | **Beta.** Assets stored persistently; **no data residency**; not BAA-covered as of 2026-07 (beta — may change; confirm at signing). Org-wide enable without a design system → generic output. [H] | This matrix |
