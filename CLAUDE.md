...
└── artifacts/
    ...
    ├── enterprise-data-boundaries.html  Per-feature trust-zone diagrams (Enterprise) · 15 features · what crosses the prompt boundary · surface-tagged (product/API/procurement/seat-plan) · per-feature BAA/ZDR/residency/retention cells · coverage table · visual companion to governance-overlay
